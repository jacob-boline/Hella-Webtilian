...
urlpatterns = [
    ...
    path(
        ...
        PasswordChangeDoneView.as_view(
            template_name="hr_access/password_change_done.html"),
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name='hr_access/password_reset_done.html'),
        name='password_reset_done'),
    path(
        "reset/<uidb64>/<token>/",
        auth_views.PasswordResetConfirmView.as_view(
            template_name="hr_access/password_reset_confirm.html",
            success_url=reverse_lazy("hr_access:password_reset_complete")),
        name="password_reset_confirm",),
    path(
        "reset/done/",
        auth_views.PasswordResetCompleteView.as_view(
            template_name="hr_access/password_reset_complete.html"),
