...
class Address(models.Model):
    ...
    def get_fields(self):
        return {"Address": self.street_address, "City": self.city, "State/Province": self.subdivision, "Zip": self.postal_code, "Country": self.country, "IS_ADDRESS": "IS_ADDRESS"}
    ...
    def formatted(self):
        ...
        city_line = ", ".join(filter(None, [self.city, self.subdivision]))
        if self.postal_code:
