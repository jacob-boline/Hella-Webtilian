...
def form_field(field, label=None, required=None, help=None, wrapper_classes="field-row field-row-full", group_classes="field-group", placeholder=None, extra_attrs=None):
    """
    ...
    if not isinstance(field, BoundField):
        log_event(logger, logging.WARNING, "common.form_field.invalid_field", field_type=type(field).__name__)
        return {
            "field": None,
            "rendered_field": "",
            "label": label or "",
